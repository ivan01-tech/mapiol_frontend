...
import { RgisterModelType, RgisterModel } from "@/models/RgisterModel";
...
const SignIn: React.FC = () => {
  ...
  const {
    ...
    handleSubmit,
    formState: { errors },
  } = useForm<RgisterModelType>({
    resolver: zodResolver(RgisterModel),
  });

  const onSubmit: SubmitHandler<RgisterModelType> = async (user) => {
    mutateAsync(user)
      .then((resp) => {
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link href="/auth/admin/login" className="text-primary">
                      Sign in
                    </Link>
                  </p>
                </div>
