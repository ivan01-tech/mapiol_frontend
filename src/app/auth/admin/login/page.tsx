...
import { loginAdminUser, loginUser } from "@/services/users.services";
...
const SignIn: React.FC = () => {
  ...
  const {
    ...
    mutationFn: loginAdminUser<any>,
    mutationKey: ["loginAdminUser"],
  });
  ...
  const onSubmit: SubmitHandler<LoginModelType> = (user) => {
    mutateAsync(user)
      .then((resp) => {
